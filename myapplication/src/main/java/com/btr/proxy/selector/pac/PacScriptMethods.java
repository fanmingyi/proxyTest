...
public class PacScriptMethods implements ScriptMethods {
	 ...
	 * isPlainHostName
	 * 
	 * @see ScriptMethods#isPlainHostName(String)
	 ************************************************************************/
	 ...
	 * isResolvableEx
	 * 
	 * @see ScriptMethods#isResolvableEx(String)
	 ************************************************************************/
	@Override
	 ...
	 * isInNetEx
	 * 
	 * @see ScriptMethods#isInNetEx(String,
	 *      String)
	 ************************************************************************/
	@Override
	 ...
	 * dnsResolveEx
	 * 
	 * @see ScriptMethods#dnsResolveEx(String)
	 ************************************************************************/
	@Override
